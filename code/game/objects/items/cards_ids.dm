...
/obj/item/card/id/dogtag/rgkombrig
	name = "Red Guard "
	desc = "Pass sheet made of leather, paper and metal. Belongs to kombrig."
	icon_state = "rgpass"
	item_state = "rgpass"
	access = list(ACCESS_REDGUARD)

/obj/item/card/id/dogtag/rgpolkovnik
	name = "Red Guard "
	desc = "Pass sheet made of leather, paper and metal. Belongs to polkovnik."
	icon_state = "rgpass"
	item_state = "rgpass"
	access = list(ACCESS_REDGUARD)

/obj/item/card/id/dogtag/rggru
	name = "Red Guard "
	desc = "Pass sheet made of leather, paper and metal. Belongs to GRU."
	icon_state = "rgpass"
	item_state = "rgpass"
	access = list(ACCESS_REDGUARD)

/obj/item/card/id/dogtag/rgscientist
	name = "Red Guard "
	desc = "Pass sheet made of leather, paper and metal. Belongs to scientist."
	icon_state = "rgpass"
	item_state = "rgpass"
	access = list(ACCESS_REDGUARD)

/obj/item/card/id/dogtag/rgstrelok
	name = "Red Guard "
	desc = "Pass sheet made of leather, paper and metal. Belongs to strelok."
	icon_state = "rgpass"
	item_state = "rgpass"
	access = list(ACCESS_REDGUARD)