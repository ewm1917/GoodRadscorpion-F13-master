...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(2) //security
			return list(ACCESS_SEC_DOORS, ACCESS_WEAPONS, ACCESS_SECURITY, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT, ACCESS_HOS, ACCESS_NCR, ACCESS_BOS, ACCESS_REDGUARD)
		if(3) //medbay
...
/proc/get_all_jobs()
	return list("Centurion", "NCR Captain", "Overseer", "Sheriff",
				...
				"Wastelander", "Raider", "Great Khan", "Preacher", "Red Guard Kombrig", "Red Guard Polkovnik", "Red Guard GRU", "Red Guard Scientist", "Red Guard Strelok")
