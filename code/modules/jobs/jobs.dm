...
GLOBAL_LIST_INIT(redguard_command_positions, list(
    "Red Guard Kombrig",
    "Red Guard Polkovnik"
))

GLOBAL_LIST_INIT(redguard_positions, list(
    "Red Guard Kombrig",
    "Red Guard Polkovnik",
    "Red Guard GRU",
    "Red Guard Strelok",
...
GLOBAL_LIST_INIT(exp_jobsmap, list(
    EXP_TYPE_CREW          = list("titles" = command_positions | brotherhood_positions | den_positions | legion_positions | ncr_positions | vault_positions | wasteland_positions | redguard_positions),
