...
/obj/item/clothing/head/helmet/sov_light
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35,"energy" = 40, "bomb" = 35, "bio" = 5, "rad" = 5, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/head/helmet/sov_heavy
	...
	armor = list("melee" = 50, "bullet" = 55, "laser" = 50,"energy" = 50, "bomb" = 45, "bio" = 35, "rad" = 45, "fire" = 40, "acid" = 40)
	flags_inv = HIDEEARS|HIDEHAIR
...
/obj/item/clothing/head/helmet/knight/fluff/metal/Initialize()
	. = ..()
	AddComponent(/datum/component/spraycan_paintable)
	START_PROCESSING(SSobj, src)

/obj/item/clothing/head/helmet/knight/fluff/metal/Destroy()
...
/obj/item/clothing/head/helmet/knight/fluff/metal/reinforced/Initialize()
	. = ..()
	AddComponent(/datum/component/spraycan_paintable)
	START_PROCESSING(SSobj, src)

/obj/item/clothing/head/helmet/knight/fluff/metal/reinforced/Destroy()
	STOP_PROCESSING(SSobj, src)
	return ..()
...
/obj/item/clothing/head/helmet/f13/combat/mk2/Initialize()
	. = ..()
	AddComponent(/datum/component/spraycan_paintable)
	START_PROCESSING(SSobj, src)

/obj/item/clothing/head/helmet/f13/combat/mk2/Destroy()
	STOP_PROCESSING(SSobj, src)
	return ..()
...
/obj/item/clothing/head/helmet/f13/combat/enclave
	...
	armor = list("melee" = 45, "bullet" = 50, "laser" = 25, "energy" = 25, "bomb" = 39, "bio" = 0, "rad" = 50, "fire" = 0, "acid" = 20)
...
/obj/item/clothing/head/helmet/f13/ncr/rangercombat
	...
	icon_state = "ranger"
	item_state = "ranger"
	armor = list("melee" = 60, "bullet" = 50, "laser" = 45, "energy" = 45, "bomb" = 55, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 20)
...
/obj/item/clothing/head/helmet/f13/ncr/rangercombat/eliteriot
	name = "elite veteran ranger helmet"
...
/obj/item/clothing/head/helmet/f13/metalmask/mk2/Destroy()
	STOP_PROCESSING(SSobj, src)
	return ..()
