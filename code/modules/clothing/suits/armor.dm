...
/obj/item/clothing/suit/armor/vest/sov_light
	...
	armor = list("melee" = 45, "bullet" = 45, "laser" = 45, "energy" = 45, "bomb" = 45, "bio" = 45, "rad" = 40, "fire" = 40, "acid" = 40)
...
/obj/item/clothing/suit/armor/vest/sov_heavy
	...
	armor = list("melee" = 65, "bullet" = 65, "laser" = 65, "energy" = 65, "bomb" = 55, "bio" = 55, "rad" = 35, "fire" = 50, "acid" = 50)
