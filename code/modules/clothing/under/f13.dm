...
/obj/item/clothing/under/f13/ps5m
	name = "Red Guard suit"
	desc = "A standard Red Guard suit.<br>The outer layer is made of a retardant material designed to withstand the harsh conditions of the wasteland."
	icon_state = "ps5m"
	item_state = "bl_suit"
	item_color = "ps5m"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list("melee" = 5, "bullet" = 5, "laser" =5, "energy" = 30, "bomb" = 5, "bio" = 30, "rad" = 40, "fire" = 45, "acid" = 50)
	can_adjust = 0
